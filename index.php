...
<div class="banner-top">
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">info@amardesh.COM</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+8801765128198</li>	
					<li class="s-bar">
						<div class="search">
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">AMAR DESH</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our AMAR DESH</h3> 
						   <p class="about-para-w3ls">We are here to do our best to insure your safety, comfort and most importantly secuerity. Just come and enjoy our service</p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2020 AMAR DESH HOTEL . All Rights Reserved |  </p>
		    </div>
<!--/footer -->
<!-- js -->
